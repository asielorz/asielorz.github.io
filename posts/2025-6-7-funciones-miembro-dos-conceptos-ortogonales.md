...
En general, la extensibilidad de las funciones miembro es un problema complicado porque el espacio de nombres de las funciones miembro es, en la práctica, global. Las extensiones que añade un módulo pueden colisionar con extensiones para el mismo tipo de otro módulo o con nuevas funciones añadidas al tipo en futuras versiones y no hay una forma fácil de organizar esto.
